...
"[project]/src/app/secure-admin/public-disclosure/documents/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DocumentsPage() {
    ...
    const fetchData = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/api/admin/content/documentation/');
    ...
    const saveItem = async ()=>{
        ...
        try {
            ...
            if (editingItem.id) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/api/admin/content/documentation/${editingItem.id}/`, formData, {
                    headers: {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/admin/content/documentation/', formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                    }
                });
    ...
    const confirmDelete = async ()=>{
        if (!deleteId) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/api/admin/content/documentation/${deleteId}/`);
            await fetchData();
            setMessage({
                type: 'success',
...
_s(DocumentsPage, "srLfsMemMRIzhOpZpGNOK8ObTTk=");
_c = DocumentsPage;
var _c;
...
//# sourceMappingURL=src_app_secure-admin_public-disclosure_documents_page_tsx_7fad018e._.js.map