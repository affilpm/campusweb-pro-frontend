...
"[project]/src/app/secure-admin/public-disclosure/general/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GeneralPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GeneralPage.useEffect": ()=>{
            fetchData();
        }
    }["GeneralPage.useEffect"], []);
    const fetchData = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/api/admin/content/general-info/');
    ...
    const saveItem = async ()=>{
        ...
        try {
            if (editingItem.id) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/api/admin/content/general-info/${editingItem.id}/`, editingItem);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/admin/content/general-info/', editingItem);
            }
            await fetchData();
            setEditingItem(null);
            setMessage({
    ...
    const confirmDelete = async ()=>{
        if (!deleteId) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/api/admin/content/general-info/${deleteId}/`);
            await fetchData();
            setMessage({
                type: 'success',
...
_s(GeneralPage, "RCL/nyboLrjJkvlHQR83HdQVQgg=");
_c = GeneralPage;
var _c;
__turbopack_context__.k.register(_c, "GeneralPage");
...
//# sourceMappingURL=src_app_secure-admin_public-disclosure_general_page_tsx_df9ddbc9._.js.map