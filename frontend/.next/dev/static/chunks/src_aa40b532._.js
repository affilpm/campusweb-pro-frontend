...
function GalleryPage() {
    ...
    const handleSave = async (e)=>{
        ...
        try {
            ...
            if (currentImage.id) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/api/admin/content/gallery/images/${currentImage.id}/`, formData, {
                    headers: {
...
_s(GalleryPage, "oKDoR643pcDZ0KkYvIG6zlzU9Zc=");
_c = GalleryPage;
var _c;
