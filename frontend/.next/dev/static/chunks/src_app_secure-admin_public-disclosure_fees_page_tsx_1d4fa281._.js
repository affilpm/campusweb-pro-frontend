...
"[project]/src/app/secure-admin/public-disclosure/fees/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FeesPage() {
    ...
    const fetchData = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/api/admin/content/fees/');
    ...
    const saveItem = async ()=>{
        ...
        try {
            if (editingItem.id) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/api/admin/content/fees/${editingItem.id}/`, editingItem);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/admin/content/fees/', editingItem);
            }
            await fetchData();
            setEditingItem(null);
            setMessage({
    ...
    const confirmDelete = async ()=>{
        if (!deleteId) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/api/admin/content/fees/${deleteId}/`);
            await fetchData();
            setMessage({
                type: 'success',
...
_s(FeesPage, "RCL/nyboLrjJkvlHQR83HdQVQgg=");
_c = FeesPage;
var _c;
__turbopack_context__.k.register(_c, "FeesPage");
...
//# sourceMappingURL=src_app_secure-admin_public-disclosure_fees_page_tsx_1d4fa281._.js.map