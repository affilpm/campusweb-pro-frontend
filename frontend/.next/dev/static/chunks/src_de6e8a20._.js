...
"[project]/src/app/secure-admin/testimonials/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TestimonialsManagementPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TestimonialsManagementPage.useEffect": ()=>{
            fetchData();
        }
    }["TestimonialsManagementPage.useEffect"], []);
    const fetchData = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/api/admin/content/testimonials/');
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            if (editing.id) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/api/admin/content/testimonials/${editing.id}/`, formData, config);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/admin/content/testimonials/', formData, config);
            }
            fetchData();
            setShowModal(false);
            setEditing(null);
    ...
    const confirmDelete = async ()=>{
        if (!deleteId) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/api/admin/content/testimonials/${deleteId}/`);
            fetchData();
        } catch (error) {
...
_s(TestimonialsManagementPage, "ibuV1U140g1zFoszwk33FNkQewM=");
_c = TestimonialsManagementPage;
var _c;
__turbopack_context__.k.register(_c, "TestimonialsManagementPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_de6e8a20._.js.map