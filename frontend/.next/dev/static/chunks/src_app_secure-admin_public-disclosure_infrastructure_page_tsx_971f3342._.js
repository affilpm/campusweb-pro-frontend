...
"[project]/src/app/secure-admin/public-disclosure/infrastructure/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function InfrastructurePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InfrastructurePage.useEffect": ()=>{
            fetchData();
        }
    }["InfrastructurePage.useEffect"], []);
    const fetchData = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/api/admin/content/infrastructure/');
    ...
    const saveItem = async ()=>{
        ...
        try {
            if (editingItem.id) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/api/admin/content/infrastructure/${editingItem.id}/`, editingItem);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/admin/content/infrastructure/', editingItem);
            }
            await fetchData();
            setEditingItem(null);
            setMessage({
    ...
    const confirmDelete = async ()=>{
        if (!deleteId) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/api/admin/content/infrastructure/${deleteId}/`);
            await fetchData();
            setMessage({
                type: 'success',
...
_s(InfrastructurePage, "RCL/nyboLrjJkvlHQR83HdQVQgg=");
...
//# sourceMappingURL=src_app_secure-admin_public-disclosure_infrastructure_page_tsx_971f3342._.js.map