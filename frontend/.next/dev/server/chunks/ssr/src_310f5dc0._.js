...
"[project]/src/app/secure-admin/achievements/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AchievementsManagementPage() {
    ...
    const fetchData = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/api/admin/content/achievements/');
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            if (editing.id) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/api/admin/content/achievements/${editing.id}/`, formData, config);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/api/admin/content/achievements/', formData, config);
            }
            fetchData();
            setShowModal(false);
            setEditing(null);
    ...
    const confirmDelete = async ()=>{
        if (!deleteId) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/api/admin/content/achievements/${deleteId}/`);
            fetchData();
        } catch (error) {
...
//# sourceMappingURL=src_310f5dc0._.js.map