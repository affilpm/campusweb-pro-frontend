...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      ...
      "Latest updates, announcements and notices from our school.",
    openGraph: {
      title: seo?.title || "All Notices | School Website",
      description:
        seo?.meta_description ||
...
export default async function NoticesPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-linear-to-br from-purple-900 via-violet-900 to-indigo-900 pt-32 pb-20 lg:pt-40 lg:pb-28 relative overflow-hidden text-white">
        {/* Decorative Elements */}
      ...
      <div className="grow py-12 sm:py-16 bg-gray-50">
