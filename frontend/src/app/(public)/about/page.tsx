  ...
  if (seo) {
    return {
      ...
      description:
        ...
        "Learn about our school history, vision, mission, and leadership.",
  ...
  return (
    <main className="overflow-hidden bg-white">
      ...
      {(data.hero_title || data.hero_subtitle) && (
        <section className="relative bg-linear-to-br from-blue-900 via-blue-800 to-indigo-900 pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
          {/* Decorative Elements */}
      ...
      {data.about_section &&
        (data.about_section.title || data.about_section.content) && (
                  ...
                  {data.about_section.image && (
                    <AnimatedSection direction="right" delay={0.2}>
                      <div className="relative">
                        <div className="absolute -inset-4 bg-linear-to-r from-blue-500/20 to-indigo-500/20 rounded-3xl blur-2xl" />
              ...
              >
                ...
                <div className={data.history_image ? "order-2 lg:order-1" : ""}>
                  ...
                  <AnimatedSection delay={0.1}>
                    ...
                    >
                      {!data.history_image && (
                        <div className="absolute top-6 left-6 text-8xl text-blue-100 font-serif leading-none select-none">
                          "
                        </div>
                      )}
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  ...
                  {data.vision_mission.vision_content && (
                    <AnimatedSection delay={0.1} direction="up">
                      <div className="group h-full bg-linear-to-br from-blue-50 to-indigo-50 rounded-3xl p-8 border border-blue-100 hover:shadow-xl hover:shadow-blue-100/50 transition-all duration-300 hover:-translate-y-1">
                        <div className="w-16 h-16 bg-linear-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-blue-500/30 group-hover:scale-110 transition-transform">
                          <svg
                  ...
                  {data.vision_mission.mission_content && (
                    <AnimatedSection delay={0.2} direction="up">
                      <div className="group h-full bg-linear-to-br from-amber-50 to-orange-50 rounded-3xl p-8 border border-amber-100 hover:shadow-xl hover:shadow-amber-100/50 transition-all duration-300 hover:-translate-y-1">
                        <div className="w-16 h-16 bg-linear-to-br from-amber-500 to-orange-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-amber-500/30 group-hover:scale-110 transition-transform">
                          <svg
                            className="w-8 h-8 text-white"
                            fill="none"
                            viewBox="0 0 24 24"
                  ...
                  {data.vision_mission.values_content && (
                    <AnimatedSection delay={0.3} direction="up">
                      <div className="group h-full bg-linear-to-br from-emerald-50 to-teal-50 rounded-3xl p-8 border border-emerald-100 hover:shadow-xl hover:shadow-emerald-100/50 transition-all duration-300 hover:-translate-y-1 md:col-span-2 lg:col-span-1">
                        <div className="w-16 h-16 bg-linear-to-br from-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-emerald-500/30 group-hover:scale-110 transition-transform">
                          <svg
                            className="w-8 h-8 text-white"
                            fill="none"
                            viewBox="0 0 24 24"
      ...
      {data.principal && data.principal.message && (
        <section className="py-16 md:py-24 bg-linear-to-br from-slate-900 via-blue-900 to-indigo-900 text-white relative overflow-hidden">
              ...
              <div className="grid md:grid-cols-3 gap-8 lg:gap-12 items-center">
                ...
                <AnimatedSection direction="left" className="md:col-span-1">
                  <div className="relative max-w-xs mx-auto md:max-w-none">
                    <div className="absolute -inset-4 bg-linear-to-r from-blue-500/30 to-indigo-500/30 rounded-3xl blur-2xl" />
                ...
                >
                  <div className="relative">
                    {/* Large quote mark */}
                    <div className="absolute -top-8 -left-4 text-9xl text-blue-500/20 font-serif leading-none select-none hidden md:block">
                      "
                    </div>
                    ...
                    {data.principal.name && (
                      <div className="mt-8 pt-6 border-t border-white/10 pl-0 md:pl-8">
                        <div className="flex items-center gap-4">
                          <div className="w-12 h-1 bg-linear-to-r from-amber-400 to-orange-400 rounded-full"></div>
        ...
        <section className="py-16 md:py-24 bg-linear-to-b from-white to-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="relative">
                {/* Timeline line */}
                <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-linear-to-b from-blue-500 via-indigo-500 to-purple-500 md:-translate-x-px"></div>
                ...
                {data.timeline.map((event, idx) => (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div className="text-4xl lg:text-5xl font-bold text-blue-600/20">
                          {event.year}
                        </div>
                      </div>
                      ...
                      <div className="flex-1 pl-16 md:pl-0">
                        <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow p-6 border border-gray-100">
                          <div className="md:hidden text-2xl font-bold text-blue-600 mb-2">
                            {event.year}
                          </div>
                          {event.title && (
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {data.facilities.map((facility, idx) => (
                  <AnimatedSection key={facility.id} delay={idx * 0.05}>
                    <div className="group bg-gray-50 hover:bg-linear-to-br hover:from-blue-50 hover:to-indigo-50 rounded-2xl p-6 border border-gray-100 hover:border-blue-200 hover:shadow-lg transition-all duration-300 cursor-default h-full">
                      <div className="flex items-start gap-4">
                        {facility.icon && (
                          <div className="shrink-0 w-12 h-12 bg-linear-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20 group-hover:scale-110 transition-transform">
                ...
                <AnimatedSection key={idx} delay={idx * 0.1}>
                  <div className="group text-center">
                    <div className="relative w-40 h-40 mx-auto mb-6">
                      <div className="absolute inset-0 bg-linear-to-br from-blue-500 to-indigo-600 rounded-full opacity-0 group-hover:opacity-100 transition-opacity blur-xl scale-110" />
                    ...
                    {member.bio && (
                      <p className="text-gray-600 text-sm mt-2 max-w-xs mx-auto line-clamp-3">
                        {member.bio}
                      </p>
                    )}
                  </div>
      ...
      {(data.affiliation_title ||
        ...
        <section className="py-16 md:py-20 bg-linear-to-r from-blue-600 to-indigo-700 text-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
