...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description =
    "Explore our world-class campus facilities designed for holistic student development.";
      ...
      <section className="relative bg-linear-to-br from-blue-900 via-blue-800 to-indigo-900 pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            State-of-the-art infrastructure designed to nurture academic
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              {facilities.map((facility, index) => (
                ...
                >
                  ...
                  <div className="h-48 bg-linear-to-br from-blue-500 to-indigo-600 flex items-center justify-center relative overflow-hidden">
