  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Hours Info - Now managed in Site Settings */}
        <section className="bg-slate-800/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
          <div className="flex justify-between items-start">
            <div>
              <h2 className="text-lg font-semibold text-white mb-2">Operating Hours</h2>
              <p className="text-sm text-gray-400 max-w-2xl">
                School Hours and Office Hours are now managed in Site Settings for consistency across the website.
              </p>
            </div>
            <a 
              href="/secure-admin/site-settings" 
