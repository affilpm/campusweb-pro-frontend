    ...
    <main className="min-h-[80vh] flex items-center justify-center bg-gray-50 px-4 pt-32 pb-20">
      <div className="max-w-xl w-full text-center">
        ...
        <div className="mb-8 relative">
           ...
           <div className="relative z-10 w-24 h-24 bg-linear-to-br from-amber-400 to-orange-500 rounded-2xl mx-auto flex items-center justify-center shadow-lg transform -rotate-6">
