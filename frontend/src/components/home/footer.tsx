    ...
    <footer className="bg-gray-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                {siteSettings.school_logo ? (
                  ...
                  <div className="w-12 h-12 bg-linear-to-br from-amber-400 to-yellow-500 rounded-xl flex items-center justify-center">
                    <span className="text-xl">🎓</span>
                  </div>
                )}
                <div>
                  <h3 className="font-bold text-lg">{siteSettings.school_name}</h3>
                  <p className="text-gray-400 text-sm">{siteSettings.school_motto}</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                {siteSettings.instagram_url && (
                  <motion.a 
                    ...
                    className="w-10 h-10 bg-white/10 hover:bg-linear-to-br hover:from-purple-600 hover:to-pink-500 rounded-lg flex items-center justify-center transition-colors"
                    whileHover={{ y: -2 }}
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            >
              ...
              <ul className="space-y-4">
                      ...
                      return (
                        <div className="flex flex-col">
                            {phones.map((phone: string, idx: number) => (
                                <a key={idx} href={`tel:${phone}`} className="text-gray-400 hover:text-amber-400 transition-colors">
                                    {phone}
                                </a>
                            ))}
                        </div>
                ...
                <li className="flex items-center gap-3">
                  ...
                  <a href={`mailto:${siteSettings.email}`} className="text-gray-400 hover:text-amber-400 transition-colors">
                    {siteSettings.email}
                  </a>
                </li>
              </ul>
          ...
          {/* Hours (New Column) - Only show if data exists */}
          {(siteSettings.school_hours || siteSettings.office_hours) && (
          <div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
        ...
        {/* Bottom Bar */}
        <div className="py-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-gray-400 text-sm">
          <p>{siteSettings.footer_text || `© ${currentYear} ${siteSettings.school_name}. All rights reserved.`}</p>
