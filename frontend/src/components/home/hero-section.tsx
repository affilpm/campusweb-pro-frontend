    ...
    <section className="relative min-h-svh flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        {data.background_image ? (
          ...
          <div className="w-full h-full bg-linear-to-br from-slate-900 via-blue-950 to-indigo-950" />
        )}
      ...
      <div className="relative z-10 w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-24 sm:py-32 lg:py-40">
          <div className="max-w-3xl">
            ...
            >
              {admissionOpen && (
                <span className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-linear-to-r from-emerald-500 to-cyan-500 text-white text-xs sm:text-sm font-semibold rounded-full shadow-lg">
            ...
            >
              {admissionOpen && (
                <Link
                  href="/admissions"
                  className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-linear-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white font-bold text-base sm:text-lg rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
                >
                  Apply Now
                  <svg
