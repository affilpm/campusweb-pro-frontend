...
export default function CTASection({ admissionOpen }: CTASectionProps) {
  return (
    <section className="relative py-16 sm:py-20 lg:py-28 bg-linear-to-br from-slate-900 via-blue-950 to-indigo-950 overflow-hidden">
      {/* Decorative Elements */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 text-center">
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-4 sm:mb-6 lg:mb-8 leading-tight">
          Ready to Begin Your{' '}
          <span className="text-transparent bg-clip-text bg-linear-to-r from-emerald-400 to-cyan-400 block sm:inline">Educational Journey?</span>
        </h2>
