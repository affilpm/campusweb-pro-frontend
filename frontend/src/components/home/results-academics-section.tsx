...
export default function ResultsAcademicsSection({ documents }: ResultsAcademicsSectionProps) {
          ...
          {documents.map((doc) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-12 h-12 bg-emerald-100 rounded-lg flex items-center justify-center text-emerald-600 group-hover:scale-110 transition-transform">
