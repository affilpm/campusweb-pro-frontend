...
export default function StatsSection({ stats }: StatsSectionProps) {
  ...
  return (
    <section className="relative bg-linear-to-br from-slate-800 via-slate-900 to-slate-800 py-12 sm:py-16 lg:py-20 overflow-hidden">
      {/* Decorative Elements */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-12">
          {stats.map((stat, index) => (
            ...
            >
              <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-transparent bg-clip-text bg-linear-to-r from-emerald-400 to-cyan-400 mb-1 sm:mb-3 tabular-nums">
                {stat.value}
              </div>
