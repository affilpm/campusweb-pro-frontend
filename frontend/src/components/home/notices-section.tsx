              ...
              {notices.map((notice, index) => (
                ...
                >
                  <div className="flex flex-row items-center gap-2 sm:gap-4 w-full h-full pr-0 sm:pr-4">
                    <span className="shrink-0 text-amber-600 font-medium text-xs sm:text-sm whitespace-nowrap bg-amber-100 px-2 py-0.5 rounded-full sm:bg-transparent sm:p-0 sm:rounded-none">
                    ...
                    {notice.is_important && (
                      <span className="shrink-0 w-2 h-2 sm:w-auto sm:h-auto rounded-full bg-red-500 sm:bg-red-100 sm:text-red-600 sm:px-2 sm:py-0.5 sm:text-xs sm:font-bold sm:rounded sm:uppercase">
