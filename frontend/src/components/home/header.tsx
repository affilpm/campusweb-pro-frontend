...
export default function Header({ siteSettings }: HeaderProps) {
  ...
  return (
    <>
      {/* Top Bar */}
      <div
        className={`fixed top-0 left-0 right-0 z-60 bg-linear-to-r ${
        ...
        } text-white text-sm transition-transform duration-400 ease-out will-change-transform ${isScrolled ? "-translate-y-full" : "translate-y-0"}`}
      >
                ...
                return (
                  <div className="relative">
                    ...
                    >
                      ...
                      <svg
                        className={`w-3 h-3 opacity-70 transition-transform ${isPhoneDropdownOpen ? "rotate-180" : ""}`}
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
          ...
          <div className="flex items-center gap-4">
            ...
            {siteSettings.instagram_url && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 flex items-center justify-center rounded-full bg-linear-to-br from-purple-600 via-pink-500 to-orange-400 hover:from-purple-500 hover:via-pink-400 hover:to-orange-300 transition-all hover:scale-110"
                title="Instagram"
      ...
      <motion.header
        ...
        style={{
          transition:
            "top 400ms ease-out, background-color 400ms ease-out, box-shadow 400ms ease-out",
        }}
        initial={{ y: -100 }}
        animate={{ y: 0 }}
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/" className="flex items-center gap-3">
                {siteSettings.school_logo ? (
                  ...
                  <div className="w-12 h-12 lg:w-14 lg:h-14 bg-linear-to-br from-emerald-500 to-cyan-600 rounded-xl flex items-center justify-center shadow-lg">
      ...
      >
        ...
        >
          ...
          <div
            className={`relative p-6 bg-linear-to-r ${
              pathname.startsWith("/academics")
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-white font-bold text-lg leading-tight">
                    {siteSettings.school_name || "Menu"}
                  </h2>
                  <p className="text-blue-200 text-xs">
                    {siteSettings.school_motto || "Navigation"}
                  </p>
                </div>
              </div>
              <button
          ...
          {/* Navigation */}
          <div
            className="relative p-4 pb-24 flex-1 overflow-y-auto overscroll-contain"
          ...
          >
            <nav className="space-y-2">
              {navLinks.map((link) => {
                ...
                return (
                  <div key={link.name} className="touch-manipulation">
                    {link.subItems ? (
                      <div>
                        <button
                          onClick={() =>
                            setOpenMobileSubMenu(
                              isSubMenuOpen ? null : link.name,
                            )
                          }
                          ...
                          <div className="ml-4 mt-1 space-y-1 border-l-2 border-blue-500/30 pl-3">
                            {link.subItems.map((subItem) => {
                              ...
                              return (
                                ...
                                >
                                  {isSubActive && (
                                    <span className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-4 bg-blue-500 rounded-full" />
                                  )}
              ...
              <div className="touch-manipulation">
                <Link
                  href="/notices"
                  prefetch={true}
                  className={`flex items-center gap-3 py-3 px-4 bg-linear-to-r from-amber-500/20 to-orange-500/20 text-amber-300 hover:from-amber-500/30 hover:to-orange-500/30 rounded-xl font-medium transition-all duration-200 border border-amber-500/30 ${pathname.startsWith("/notices") ? "ring-2 ring-amber-400/50" : ""}`}
                  onClick={(e) => {
                    e.preventDefault();
                    handleNavigation("/notices");
                  }}
                >
                  <div className="relative">
                    <svg
          ...
          {/* Footer Social Links */}
          <div className="absolute bottom-0 left-0 right-0 p-4 bg-linear-to-t from-slate-900 via-slate-900/95 to-transparent pt-8">
            ...
            <div className="flex items-center gap-2">
              ...
              {siteSettings.instagram_url && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 flex items-center justify-center rounded-lg bg-pink-500/20 text-pink-400 hover:bg-linear-to-br hover:from-purple-600 hover:via-pink-500 hover:to-orange-400 hover:text-white transition-all duration-200"
                >
                  <svg
                    className="w-4 h-4"
                    fill="currentColor"
